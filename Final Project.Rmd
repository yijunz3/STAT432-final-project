...
data_cat = data_rs = data_x %>%
  select(matches("mu_"),matches("cn_"))
...
```{r}
#Check the histogram of first 10 continuous variables
for (i in 1:10) {
  hist(log(data_continous[,i]), xlab = colnames(data_continous)[i])
}
